package project.personal.parkingsystem.Controller.Mapper;
...
public class ParkingMapper {
	...
	public ParkingDTO toParkingDTO(Parking parking) {//inicia um objeto e transfere os atributos do outro objeto
